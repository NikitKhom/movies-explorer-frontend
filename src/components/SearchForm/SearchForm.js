    ...
    <section>
        <form className='search-form' onSubmit={onSubmit}>
            <div className='search-form__seacrh-line'>
                <input className='search-form__input' type='text' name='search' placeholder='Фильм' value={value} onChange={onInputChange} autoComplete='off'/>
                <button className='search-form__submit-btn' type='submit'>Найти</button>
            </div>
            <input className='search-form__checkbox' checked={checked} type='checkbox' id='filter' onChange={onCheckboxChange}/>
